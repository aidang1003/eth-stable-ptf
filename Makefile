...
deploy-mainnet :
	@forge script script/DeployGlobalAllocation.s.sol:DeployGlobalAllocation --rpc-url $(MAINNET_RPC_URL) --account scaffold-eth-custom --broadcast --verify --etherscan-api-key $(ETHERSCAN_API_KEY) -vvvv